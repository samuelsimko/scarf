...
a_c_c alm2phase_weights_ginfo(sharp_geom_info *ginfo, const a_c_c &alm, const int64_t lmax,
      const int64_t mmax, const int nthreads, a_d &zbounds, py::object &out){
...
a_c_c phase2alm_noweights_ginfo(sharp_geom_info *ginfo, a_c_c &phase_p2a, size_t lmax, size_t mmax, size_t nthreads, a_d &zbounds) {
  ...
  sharp_phase2alm(&ar[0], phase_mav_p2a, *ginfo_new, *ainfo, 0, nthreads);
  return alm;
}
...
a_d_c phase2map_weights_ginfo(sharp_geom_info *ginfo, a_c_c &phase, size_t lmax, size_t mmax, size_t nthreads, a_d &zbounds) {
...
a_c_c map2phase_noweights_ginfo(sharp_geom_info *ginfo, a_d_c &map, size_t lmax, size_t mmax, size_t nthreads, a_d &zbounds,
    py::object &out) {
  ...
  phase_job job(SHARP_Yt, 0, {&ar[0]}, {&mr[0]}, phase_mav, *ginfo_new, *ainfo, 0, nthreads);
  phase_execute_map2phase(job, phase_mav, *ginfo_new, mmax, 0);
  return phase_m2p;
}
...
PYBIND11_MODULE(scarf, m) {
  ...
  py::class_<sharp_geom_info>(m ,"Geometry")
    ...
    .def("weight", &sharp_geom_info::weight, "iring"_a)
    ...
    .def("map2phase_noweights", &map2phase_noweights_ginfo, "map"_a, "lmax"_a, "mmax"_a, "nthreads"_a, "zbounds"_a, "out"_a=py::none())
    .def("phase2map_weights", &phase2map_weights_ginfo, "phase"_a, "lmax"_a, "mmax"_a, "nthreads"_a, "zbounds"_a)
    .def("alm2phase_weights", &alm2phase_weights_ginfo, "alm"_a, "lmax"_a, "mmax"_a, "nthreads"_a, "zbounds"_a, "out"_a=py::none())
    .def("phase2alm_noweights", &phase2alm_noweights_ginfo, "phase"_a, "lmax"_a, "mmax"_a, "nthreads"_a, "zbounds"_a)
